...
export default function Autolesiones({ navigation }) {
    ...
    <Container>
      ...
      <View style={{ margin: 10 }}>
        <Title style={{
          ...
          ¿Reportar esta publicación por autolesiones?
    </Title>
        <Paragraph style={{
        ...
        <View style={{ margin: 10 }}>
          <Caption style={{
            ...
            <Text>{'\u2B24'}</Text> Atentar las autolesiones tales como: El abuso de drogas,
          ...
          <Caption style={{
            ...
            <Text>{'\u2B24'}</Text> Representaciones gráficas de las autolesiones
    </Caption>
          <Caption style={{
            textAlign: 'justify', fontSize: 15, marginEnd: 1,
            fontFamily: "Poppins_400Regular"
          }}>
            <Text>{'\u2B24'}</Text> Publicaciones que implican una lesión musuclar o provocar
            algun tipo de fractura.
    </Caption>
        </View>
