...
export default function NoPor({ navigation }) {
  ...
  return (
    ...
    <Container>
      ...
      <View style={{ margin: 10 }}>
        <Title style={{ textAlign: 'justify', fontSize: 24,
      fontFamily: "Poppins_500Medium"
      }}>
          ¿Reportar esta publicación por mal uso de #etiquetas?
    </Title>
      ...
      fontFamily: "Poppins_400Regular"
        ...
        <View style={{ margin: 10 }}>
         ...
         fontFamily: "Poppins_400Regular"
            ...
            <Text>{'\u2B24'}</Text> Publicaciones con una mal uso de etiquetas Ej: el usuario
            comparte foto de una receta y cita la etiqueta #MisEjercicios
    </Caption>
          <Caption style={{ textAlign: 'justify', fontSize: 15, marginEnd: 1,
         fontFamily: "Poppins_400Regular"
        }}>
            <Text>{'\u2B24'}</Text> Publicaciones sin etiquetas.
    </Caption>
        </View>
