  ...
  return (
    ...
    <Container>
      ...
      <View style={{ margin: 10 }}>
        <Title style={{
          textAlign: 'justify', fontSize: 22,
          fontFamily: "Poppins_500Medium"
        }}>
          ¿Reportar esta publicación por desnudez o pornografía?
    </Title>
        <Paragraph style={{
        ...
        <View style={{ margin: 10 }}>
          <Caption style={{
            ...
            <Text>{'\u2B24'}</Text> Lenguaje sexual explícito.
    </Caption>
          <Caption style={{
            textAlign: 'justify', fontSize: 15, marginEnd: 1,
            fontFamily: "Poppins_400Regular"
          }}>
            <Text>{'\u2B24'}</Text> Ofrecimiento o solicitud de actividad sexual.
    </Caption>
          <Caption style={{
            textAlign: 'justify', fontSize: 15, marginEnd: 1,
            fontFamily: "Poppins_400Regular"
          }}>
            <Text>{'\u2B24'}</Text> Desnudos en los que se muestran genitales.
    </Caption>
          <Caption style={{
            textAlign: 'justify', fontSize: 15, marginEnd: 1,
            fontFamily: "Poppins_400Regular"
          }}>
            <Text>{'\u2B24'}</Text> Publicaciones con actividad sexual.
    </Caption>
        </View>
