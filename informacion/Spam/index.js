...
import { Title, Caption, Headline, Subheading, Paragraph, Snackbar } from 'react-native-paper';
  ...
  return (
    ...
    <Container>
      ...
      fontFamily: "Poppins_500Medium"
          ...
          ¿Reportar esta publicación por spam?
    </Title>
        <Paragraph style={{ textAlign: 'justify', fontSize: 14, marginEnd: 20,
